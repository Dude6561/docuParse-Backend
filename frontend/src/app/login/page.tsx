...
export const metadata: Metadata = {
  title: "Sign In - DocuParse Nepal",
  description:
    "Sign in to DocuParse Nepal to access your OCR dashboard, upload documents, and export data.",
};

export default function LoginPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-white pt-16 pb-16">
      {/* Background grid */}
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="rounded-2xl border border-[var(--color-border)] bg-white p-8 shadow-sm">
          ...
          >
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-3 rounded-xl bg-neutral-900 px-5 py-3.5 text-sm font-medium text-white transition-all hover:bg-black"
            >
          ...
          <div className="space-y-3">
            <button
              disabled
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-[var(--color-border)] px-5 py-3.5 text-sm font-medium text-neutral-400 cursor-not-allowed"
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <p className="mt-8 text-center text-xs text-neutral-400 leading-relaxed">
            By continuing, you agree to DocuParse&apos;s{" "}
